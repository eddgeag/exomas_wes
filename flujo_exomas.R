...
snpeff <- function(input_directory = output_directory, dir_snpeff) {
  output_folder <- file.path(input_directory, "anotacion")
  
  file_input <-
    file.path(input_directory, "calling_variants", "freebayes_norm.vcf")
  
  file_output1.hg19 <- file.path(output_folder, "annotated_hg19.vcf")
  file_output2.hg19 <- file.path(output_folder, "annotated_hg19_pred.vcf")
  file_output3.hg19 <- file.path(output_folder, "annotated__hg19_clin.vcf")
  
  file_output1.hg38 <- file.path(output_folder, "annotated_hg38.vcf")
  file_output2.hg38 <- file.path(output_folder, "annotated_hg38_pred.vcf")
  file_output3.hg38 <- file.path(output_folder, "annotated__hg38_clin.vcf")
  ...
  campos_data_hg19 <-
    list.files(file.path(dir_snpeff, "data", "dbNSFP", "hg19"), pattern = "gz$")
  campos_data_hg38 <-
    list.files(file.path(dir_snpeff, "data", "dbNSFP", "hg38"), pattern = "gz$")
  
  clinvar_hg19 <-
    list.files(file.path(dir_snpeff, "data", "clinvar", "GRCh37"), "gz$")
  clinvar_hg38 <-
    list.files(file.path(dir_snpeff, "data", "clinvar", "GRCh37"), "gz$")
